...
class BusinessScreen2State extends State<BusinessScreen2> {
  ...
  void _onNextPressed() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => BusinessScreen3()),
    );
  }
